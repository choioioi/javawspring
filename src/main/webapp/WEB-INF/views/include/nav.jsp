...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://192.168.50.63:9090/javawspring" class="w3-bar-item w3-button w3-padding-large">HOME</a>
    <a href="${ctp}/guest/guestList" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Guest</a>
    <c:if test="${sLevel <= 4}"> <!-- 인터셉터에서 비회원은 게시판 못들어가게 막았고 이건 홈페이지에 보이지도 않게 하는 것, 빼고 싶으면 빼면 됨 -->
    ...
    <c:if test="${empty sLevel}"> <!-- sLevel이 비어있으면 Login창과 join창 뜸 -->
